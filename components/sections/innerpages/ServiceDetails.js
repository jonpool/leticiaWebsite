                ...
                <div class="service-sidebar">
                  <div class="sidebar-widget service-sidebar-single">
                    ...
                    <div class="sidebar-service-list">
                      <ul>
                        <li><Link href="page-service-details" class="current"><i class="fas fa-angle-right"></i><span>Deep Massage</span></Link></li>
                        <li class="current"><Link href="page-service-details"><i class="fas fa-angle-right"></i><span>Facial Treatments</span></Link></li>
                        <li><Link href="page-service-details"><i class="fas fa-angle-right"></i><span>Body Treatments</span></Link></li>
                        <li><Link href="page-service-details"><i class="fas fa-angle-right"></i><span>Nail Care</span></Link></li>
                        <li><Link href="page-service-details"><i class="fas fa-angle-right"></i><span>Body Glow & Wraps</span></Link></li>
                        <li><Link href="page-service-details"><i class="fas fa-angle-right"></i><span>Hair Salon</span></Link></li>
                      </ul>
                    </div>
