                    ...
                    <div className="row">
                        ...
                        <div className="service-block-two col-lg-4 col-md-6">
                            <div className="inner-box">
                                ...
                                <figure className="image-two mb-0"><img src="images/resource/service2-4.jpg" alt="Image"/></figure>
                        ...
                        <div className="service-block-two col-lg-4 col-md-6">
                            <div className="inner-box">
                                <div className="bg bg-image" style={{ backgroundImage: 'url(/images/resource/service2-3.png)' }}></div>
                                <figure className="image-two mb-0"><img src="images/resource/service2-5.jpg" alt="Image"/></figure>
                                <div className="content-box-hover">
                                    <div className="content-box">
                        ...
                        <div className="service-block-two col-lg-4 col-md-6">
                            <div className="inner-box">
                                <div className="bg bg-image" style={{ backgroundImage: 'url(/images/resource/service2-3.png)' }}></div>
                                <figure className="image-two mb-0"><img src="images/resource/service2-6.jpg" alt="Image"/></figure>
                                <div className="content-box-hover">                                
                                    <div className="content-box">
